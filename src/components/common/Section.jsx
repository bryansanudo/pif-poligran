...
const Section = ({ title, subtitle, children, name }) => {
  return (
    <div>
      ...
      >
        <p className="font-bold text-4xl my-8 text-center text-transparent bg-clip-text  bg-gradient-to-r from-[#e67c04] to-[#5C24B3]  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 md:text-5xl uppercase ">
          {title}
        </p>
